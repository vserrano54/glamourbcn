<header class="wave mb-5" id="inicio">
      <div class="container">
         <div class="row mt-5 ">
            ...
            <div class="col ms-md-5 mt-3 mt-md-0 text-center-xs fondo-main" style="z-index: 1; ">
                <h1 class="fw-normal text-center">Perfección y glamour</h1>
               <img class="img-fluid" width="700" src="assets/img/portada.png">
            </div>
         </div>
      </div>
   </header>